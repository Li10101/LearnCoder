...
public class CustomerCameraActivity extends AppCompatActivity {
    ...
    private final String[] mTitles = {
            "Camera", "ImageTextView", "CanvasDashBoard"
            , "画饼图", "Bitmap", "设计", "工具资源"
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(SimpleFragment9.getInstance(""));



        vpCustomerTest.setAdapter(new CustomerCameraActivity.MyPageAdapter(getSupportFragmentManager()));
