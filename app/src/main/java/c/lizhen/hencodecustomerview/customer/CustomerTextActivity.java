...
import c.lizhen.hencodecustomerview.fragment.SimpleFragment7;
import c.lizhen.hencodecustomerview.fragment.SimpleFragment8;

public class CustomerTextActivity extends AppCompatActivity {
    ...
    private final String[] mTitles = {
            "Text", "ImageTextView", "CanvasDashBoard"
            , "画饼图", "Bitmap", "设计", "工具资源"
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(SimpleFragment7.getInstance(""));
        fragments.add(SimpleFragment8.getInstance(""));


        vpCustomerTest.setAdapter(new CustomerTextActivity.MyPageAdapter(getSupportFragmentManager()));
