...
public class ScalebleImageView1 extends View implements NestedScrollingChild2 {
    ...
    public ScalebleImageView1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    @Override
    public boolean startNestedScroll(int axes, int type) {//做初始化
    ...
    @Override
    public boolean hasNestedScrollingParent(int type) {//是否有滑动的父控件
